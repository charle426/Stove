      ...
      <div className="bg-[#272B33] rounded-[50px] p-5">
        ...
        <div>
          <h3 className="text-white text-[20px] mb-3">
            We offer service like cooking gas installation services for your gas cylinders, for a fair fee 
          </h3>
          <div className="flex md:justify-end justify-center items-center">
            <div className="bg-[#2F353F] hover:bg-[#3A424E] md:flex-row-reverse flex-col-reverse flex text-white p-5 duration-200 rounded-[20px] items-center">
              ...
              <div>
                <h1 className="text-[30px] mb-3">Gas cooker installation</h1>
                <p>Get all your gasoline and gas cooker <br/> products for your price</p>
